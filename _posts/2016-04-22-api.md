...
When using the conventional Flux approach you have access to the dispatcher instance passed while the Action Provider's creation.

 
 <script type="application/javascript">
 $.easing.inOutQuart =  function (x, t, b, c, d) 
 {
